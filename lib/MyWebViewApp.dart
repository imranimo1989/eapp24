import 'package:eapp24/app_res.dart';
...
Page resource error:
  ...
  isForMainFrame: ${error.isForMainFrame}
      ...
      ..loadRequest(Uri.parse(AppRes.home));
...
// backgroundColor: Colors.green,
      appBar: AppBar(
        ...
        backgroundColor: AppRes.appColor,
        title: const Text('Eapp24'),
...
/*  Widget favoriteButton() {
    return FloatingActionButton(
      backgroundColor: const Color(0xFF020381),
      onPressed: () async {
